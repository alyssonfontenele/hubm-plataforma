-- =============================================================================
-- SEED LOCAL — HubM Plataforma
-- Executar via: npx supabase db reset  (carregado automaticamente após migrations)
-- Banco local simula o ambiente Moveria para testes de integração.
--
-- Inclui:
--   1. companies (mowig + moveria) — guard das migrations moveria_* depende de slug 'moveria'
--   2. Usuários de teste (auth.users + auth.identities + public.profiles)
--   3. Dados Moveria (membros, clientes, contratos, itens, designações)
-- =============================================================================
...
-- ============================================================
-- STEP 1: companies
-- mowig  — empresa Mowig (banco local simula Moveria, mas inserimos
...
-- Corrige campos que GoTrue não aceita como NULL
...
-- ============================================================
-- STEP 7: moveria_contratos
-- ============================================================
INSERT INTO moveria_contratos (
  id, numero, numero_base, versao, cliente_id, vendedor_id,
...
ON CONFLICT (numero_base, versao) DO NOTHING;

-- ============================================================
-- STEP 8: moveria_itens_contrato (6 itens)
-- ============================================================
...
-- ============================================================
-- STEP 9: moveria_designacoes
-- Trigger sincroniza consultor_designado nos itens automaticamente
-- ============================================================
